        ...
        return InlineKeyboardMarkup([
            [
                InlineKeyboardButton(
                    ...
                    url=("t.me/JuxJJ" if botData['session']['username'] is None
    ...
    def SHOW_CHAT():
        ...
        for chatID, chatData in botData['chats'].items():
            keybaord.append([
                ...
                InlineKeyboardButton(text=chatData['title'], url=f"t.me/{'JuxJJ' if not chatData['username'] else chatData['username']}"), 
